...
using AESCConstruct25.Modules.Profiles;
...
namespace AESCConstruct25.Modules
{
    public static class ProfileModule
    {
        ...
        {
            // Print the 3×3 rotation + translation (4th column) on one line:
            // [m00 m01 m02 m03; m10 m11 m12 m13; m20 m21 m22 m23]
            return $"[ {m[0, 0]:F3}, {m[0, 1]:F3}, {m[0, 2]:F3}, {m[0, 3]:F3} ; " +
                   $"{m[1, 0]:F3}, {m[1, 1]:F3}, {m[1, 2]:F3}, {m[1, 3]:F3} ; " +
                   $"{m[2, 0]:F3}, {m[2, 1]:F3}, {m[2, 2]:F3}, {m[2, 3]:F3} ]";
        }
