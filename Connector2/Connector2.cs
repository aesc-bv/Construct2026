...
public class Connector2
{
    ...
    /// <summary>Parses the WPF connector form fields and returns a new <see cref="Connector2"/> instance, or null on failure.</summary>
    public static Connector2 CreateConnector(Connector2Control form)
    {
        ...
        try
        {
            ...
            {
                if (NumberParsing.TryParseUserInput(s, out var v))
                    return v;
